...
\def\lxirvmathenv#1{\xBegin{#1}\refstepcounter{equation}\begingroup\@formule \frenchspacing\@vobeyspaces
              \formule@start}
\def\endlxirvmathenv#1{\endgroup\xEmptyA{eqnnum}{value=\theequation}\xEnd{#1}}
\def\lxirvmathenvstar#1{\xBegin{#1}\begingroup\@formule \frenchspacing\@vobeyspaces
              \formule@start}
\def\endlxirvmathenvstar#1{\endgroup\xEnd{#1}}
