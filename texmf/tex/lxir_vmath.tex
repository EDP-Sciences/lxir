...
\def\equation{\xBegin{equation}\refstepcounter{equation}\begingroup\@formule \frenchspacing\@vobeyspaces
              \formule@start}
\def\endequation{\endgroup\xEmptyA{eqnnum}{value=\theequation}\xEnd{equation}}
\def\eqnarray{%
   \xBegin{eqnarray}%
   \stepcounter{equation}%
   \begingroup\@formule \frenchspacing\@vobeyspaces
              \formule@start}
\def\endeqnarray{%
      \endgroup\t@gOntrue\xEnd{eqnarray}}
