...
%
\def\bar#1{\xBegin{math-above-bar}#1\xEnd{math-above-bar}}
\def\dot#1{\xBegin{math-above-dot}#1\xEnd{math-above-dot}}
\def\hat#1{\xBegin{math-above-hat}#1\xEnd{math-above-hat}}
